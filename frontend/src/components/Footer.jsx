  ...
  return (
    <footer className="footer">
      <div className="footer-inner">
        ...
        <div className="footer-brand">
          <div className="footer-logo-wrap">
            <img src="/images/logo.png" alt="Agadhi Choorna Logo" className="footer-logo" />
          </div>
        ...
        <div className="footer-col">
          ...
          <ul className="footer-contact-list">
            ...
            <li>
              ...
              <a
                href="https://wa.me/919539416003?text=Hello,%20I'd%20like%20to%20place%20an%20order%20for%20Agadi%20Choornam."
                target="_blank"
      ...
      <div className="footer-bottom">
        <p>&copy; {new Date().getFullYear()} Agadhi Choorna. All Rights Reserved.</p>
        <div className="social-icons">
          ...
          <a href="https://wa.me/919539416003" target="_blank" rel="noopener noreferrer" className="social-icon-btn" aria-label="WhatsApp">
