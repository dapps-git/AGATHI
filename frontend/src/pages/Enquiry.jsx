...
const durationsList = ['0:45', '0:38', '0:51', '0:42', '0:48', '0:35', '0:40', '0:55', '0:32', '0:36', '0:44', '0:50', '0:41', '0:39', '0:52', '0:37', '0:47', '0:46', '0:43', '0:40', '0:54', '0:33', '0:42', '0:30', '0:53', '0:51', '0:44', '0:31', '0:42', '0:48', '0:38', '0:38', '0:36'];

const staticVoiceItems = Array.from({ length: 33 }, (_, i) => {
  const index = i + 1;
  return {
    ...
    duration: durationsList[i % durationsList.length],
    quote: quotesList[i % quotesList.length]
  };
});

const waVoiceItems = waAudioFiles.map((file, i) => {
  const index = 33 + i + 1;
  return {
    _id: `audiorev-wa-${i + 1}`,
    id: index,
    name: 'Verified Review',
    location: 'Kerala',
    src: `/audioreview/${file}`,
    audioUrl: `/audioreview/${file}`,
    duration: durationsList[(i + 5) % durationsList.length],
    quote: quotesList[(i + 3) % quotesList.length]
  };
});

const CUSTOMER_VOICE_REVIEWS = [...staticVoiceItems, ...waVoiceItems];
